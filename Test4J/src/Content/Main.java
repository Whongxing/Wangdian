...
public class Main {
	...
	public static File[] sort(File[] s){
	        ...
	        for(int j = 0; j<s.length-1;j++){
				...
				// 找到最小值
				if (min.substring(0, min.indexOf(".")).compareTo( s[k].getName()
						.substring(0, s[k].getName().indexOf(".")))==1) {
					// 修改最小
					min = s[k].getName();
					minIndex = k;
				}
